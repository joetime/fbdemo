...
var userSchema = require('./data/user.js').initUser(mongoose);
var User = mongoose.model('User', userSchema);

//var testSchema = require('./data/team.js').initTest(mongoose);  
...
//require('./api.generic.js').initRoutes(app, Test, 'tests');
